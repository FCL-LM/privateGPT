...
PERFORMANCE_DATA_TIME_FILE: Performance logging file as a csv
PERFORMANCE_DATA_SOURCES_FILE: Sources logging file as a csv
N_CORES(optional): Number of cores used , defaults to all cores 
```
